...
- **Heading Font:** Outfit (600/500) — giữ stack hiện có, tránh Inter (taste-skill)
- **Body Font:** Outfit (400/500)
- **Mono / Data:** JetBrains Mono + `tabular-nums`
- **Banned on admin:** Playfair Display / serif display; neon text-shadow
- **Mood:** minimal, clean, functional, professional ops
- **Google Fonts:** [Outfit + JetBrains Mono](https://fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400;500;600;700&family=Outfit:wght@400;500;600;700&display=swap)
